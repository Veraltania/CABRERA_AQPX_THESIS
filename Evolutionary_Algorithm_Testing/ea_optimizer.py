...
import control as ct
import matplotlib.pyplot as plt
from Evolutionary_Algorithm_Testing.solver_engine import JuliaSolverEngine
...
class EvolutionaryOptimizer(ABC):
    def __init__(self, config, tf_params):
        ...
        self.solver_engine = JuliaSolverEngine()
    ...
    def calculate_itae_cost(self, Kp, Ki):
        ...
        # 3. Compute and Cache
        try:
            cost = self.solver_engine.evaluate(Kp, Ki, self.K_plant, self.T_plant, self.delay)
