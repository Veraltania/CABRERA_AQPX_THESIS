...
class CrossoverSweepGAOptimizer(GAOptimizer):
    def __init__(self, config, tf_params):
        ...
        # 1. Convert num_parents_mating if it's a percentage (retaining your standard functionality)
        ...
        # 2. OVERRIDE: Replace the hardcoded 0.90 crossover probability from the base class
        # with the dynamic sweep value provided by OptimizationSweeper.
...
if __name__ == '__main__':
    ...
    base_config = {
        ...
        'patience': 20,             
        'tol': 1e-3,                
        'num_parents_mating': 0.5,  # Percentage of population size
        'parent_selection_type': "rank",
        'keep_elitism': 2,          # Fixed elitism count since we aren't sweeping it
        'crossover_type': "scattered"
    }

    # --- 4. CONFIGURE SWEEP PARAMETERS ---
    # Crossover Probability (Pc) usually scales from 0.0 to 1.0. 
