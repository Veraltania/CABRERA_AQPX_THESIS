...
# --- 1. THE WRAPPER CLASS ---
class PercentageElitismGAOptimizer(GAOptimizer):
...
if __name__ == '__main__':
    ...
    base_config = {
        ...
        'patience': 20,             
        'tol': 1e-3,                
        'num_parents_mating': 0.5,  # percentage of the population size
    ...
    sweep_config = {
        'label': 'Elitism_Percentage',
        'keys': ['keep_elitism'],
        'values': dynamic_values, 
        'pop_sizes': [50]  
    }

    output_dir = os.path.join(SCRIPT_DIR, 'GA_SWEEP_ELITISM_PCT')

    sweeper = OptimizationSweeper(
        optimizer_class=PercentageElitismGAOptimizer, 
