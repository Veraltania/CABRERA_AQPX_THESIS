...
def extract_and_process(file_paths, start_time, end_time, target_column, window_seconds=60, time_col='Timestamp'):
    """
...
def analyze_open_loop(file_paths, start_step, end_step, target_column, window_seconds, tf_name, t_step_time, delta_u):
    ...
    t_step_rel = (pd.to_datetime(t_step_time) - df['Timestamp'].iloc[0]).total_seconds()
...
if __name__ == "__main__":
    ...
    # ==========================================
    base_data_path = r'D:\aqpx\Cabrera_Thesis_AQPX\Open_Loop_Modeling\data'
    tds_files = [
